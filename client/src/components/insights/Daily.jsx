...
const getAlertStyle = (sev) =>
  ({
    critical: "bg-red-50 border-red-300",
    high: "bg-orange-50 border-orange-300",
    medium: "bg-amber-50 border-amber-300",
  })[sev] ?? "bg-blue-50 border-blue-300";
const getInsightAccent = (t) =>
  ({
    ...
    icon: "📌",
    tag: "Note",
    tagColor: "text-gray-600 bg-gray-50",
  };
...
export default function Daily({ dailyData, onRefresh, userId }) {
  ...
  const funActivities = [
    {
      title: "Dance Break",
      description: "Put on your favourite song and dance for 3 minutes",
      icon: "💃",
      duration: "3 min",
    },
    {
    ...
    {
      title: "Plant Care",
      description: "Water a plant or spend 10 minutes in nature",
      icon: "🌿",
      duration: "10 min",
    },
    {
      title: "Read & Relax",
      description: "Read a chapter of a book or an interesting article",
      icon: "📖",
      duration: "15 min",
    },
    {
      title: "Doodle Time",
      description: "Draw freely for 5 minutes without judgment",
      icon: "✏️",
      duration: "5 min",
    },
    {
      title: "Mindful Tea",
      description: "Make your favourite drink and enjoy it slowly",
      icon: "🍵",
      duration: "10 min",
    },
    {
