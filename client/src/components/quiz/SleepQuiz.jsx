// src/components/quiz/SleepQuiz.jsx
...
const SleepQuiz = ({ userId }) => {
  ...
  // Fetch 10 random sleep questions from the API
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        console.error("Error fetching sleep quiz:", error);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F3E5F5]">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#5D4037] font-medium">Loading sleep assessment...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F3E5F5]">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#8D6E63] text-sm">Analysing your sleep responses 🌙</p>
        </div>
      </div>
    );
  }
            ...
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-[#5D4037] max-w-md mx-auto font-medium">
                  Your sleep assessment has been recorded
                </p>
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#5D4037] text-sm md:text-base font-medium opacity-70">
              Understanding your sleep quality and patterns
            </p>
          </div>
          ...
          >
            ...
            <div className="flex gap-4 justify-between items-center pt-4 border-t border-purple-100">
              {showValidation && (
                <p className="text-red-500 text-xs font-medium absolute -mt-8">⚠️ Please select an answer before continuing</p>
              )}
              <button
