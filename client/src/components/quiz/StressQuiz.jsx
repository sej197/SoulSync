...
const StressQuiz = ({ userId }) => {
  ...
  // Fetch 10 random stress questions from the API
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        console.error("Error fetching stress quiz:", error);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F3E5F5]">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#5D4037] font-medium">Loading stress assessment...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F3E5F5]">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#8D6E63] text-sm">Analysing your stress responses 🌿</p>
        </div>
      </div>
    );
  }
