...
const AnxietyQuiz = ({ userId }) => {
  ...
  // Fetch 10 random anxiety questions from the API
  useEffect(() => {
    const fetchQuestions = async () => {
      try {
        ...
        console.error("Error fetching anxiety quiz:", error);
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F3E5F5]">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#5D4037] font-medium">Loading anxiety assessment...</p>
        </div>
      </div>
    );
  }
    ...
    return (
      <div className="min-h-screen flex items-center justify-center bg-[#F3E5F5]">
        <div className="text-center space-y-4">
          ...
          <p className="text-[#8D6E63] text-sm">Analysing your anxiety responses 🧘</p>
        </div>
      </div>
    );
  }
            ...
            <div className="text-center space-y-8">
              ...
              <div className="space-y-4">
                ...
                <p className="text-xl text-[#5D4037] max-w-md mx-auto font-medium">
                  Your anxiety assessment has been recorded
                </p>
              </div>
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-[#5D4037] text-sm md:text-base font-medium opacity-70">
              Understanding your anxiety patterns today
            </p>
          </div>
