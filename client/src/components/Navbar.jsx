...
const Navbar = () => {
    return (
        <div className="navbar bg-base-100/90 backdrop-blur-md sticky top-0 z-50 border-b border-gray-100">
            ...
            <div className="navbar-end">
                <button className="btn btn-ghost text-bllom-muted hover:text-bloom-primary">Logout</button>
            </div>
        </div>
    );
};
